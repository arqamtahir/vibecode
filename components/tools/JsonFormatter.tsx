    ...
    <div className="grid gap-6 lg:grid-cols-2">
      ...
      <div className="flex flex-col">
        <div className="flex flex-wrap items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <select
              ...
              className="rounded-lg border border-[var(--border-hairline)] [background:var(--bg-elevated)] px-2 py-1.5 text-sm text-primary focus:border-[var(--accent)] focus:outline-none"
            >
        ...
        <div className="mt-3 flex flex-wrap gap-2">
          <button type="button" onClick={() => run("format")} className="btn-primary">
            Format
          </button>
          <button
            type="button"
            onClick={() => run("minify")}
            className="inline-flex items-center rounded-full border border-[var(--border-hairline)] px-5 py-2.5 text-sm font-medium text-primary transition-colors hover:border-[var(--accent)]"
          >
            Minify
          </button>
          <button
        ...
        <div aria-live="assertive" role="alert" className="mt-3">
          {error ? (
            <div className="rounded-xl border border-[var(--danger)] [background:color-mix(in_srgb,var(--danger)_10%,transparent)] p-3">
              ...
              {errorContext ? (
                <pre className="mt-2 overflow-x-auto rounded-lg [background:var(--bg-elevated)] p-2 font-mono text-xs text-primary">
