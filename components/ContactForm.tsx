...
export function ContactForm() {
  ...
  if (status === "success") {
    return (
      <div role="status" aria-live="polite" className="panel p-8 text-center">
        ...
        <button
          ...
          className="mt-6 inline-flex items-center rounded-full border border-[var(--border-strong)] px-5 py-2.5 text-sm font-medium text-primary transition-colors hover:bg-[var(--bg-inset)]"
        >
    ...
    <form onSubmit={onSubmit} noValidate className="panel space-y-5 p-6 sm:p-8">
      <div>
        ...
        <input
          ...
          className="mt-1.5 w-full rounded-lg border border-[var(--border-hairline)] [background:var(--bg-elevated)] px-3 py-2.5 text-primary focus:border-[var(--accent)] focus:outline-none"
        />
        {errors.name ? (
          <p id={`${nameId}-error`} className="mt-1.5 text-sm text-[var(--danger)]">
            {errors.name}
          </p>
        ) : null}
      </div>
      ...
      <div>
        ...
        />
        {errors.email ? (
          <p id={`${emailId}-error`} className="mt-1.5 text-sm text-[var(--danger)]">
            {errors.email}
          </p>
        ) : null}
      </div>
